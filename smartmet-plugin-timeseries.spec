...
%if %{with observation}
BuildRequires: smartmet-engine-observation-devel >= 21.8.19
%endif
BuildRequires: smartmet-engine-querydata-devel >= 21.8.19
...
Requires: smartmet-engine-querydata >= 21.8.19
...
#TestRequires: smartmet-engine-querydata >= 21.8.19
%if %{with observation}
