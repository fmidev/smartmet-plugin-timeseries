...
#%if %{with observation}
#Requires: smartmet-engine-observation >= 26.5.27
#%endif
...
#TestRequires: smartmet-engine-gis >= 26.5.8
#TestRequires: smartmet-engine-querydata >= 26.4.13
%if %{with observation}
#TestRequires: smartmet-engine-observation >= 26.5.27
%endif
...
* Fri Jan 16 2026 Mika Heiskanen <mika.heiskanen@fmi.fi> 26.1.16-1.fmi
...
* Tue Aug 19 2025 Mika Heiskanen <mika.heiskanen@fmi.fi> - 25.8.19-2.fmi
- Improved error messages on duplicate parameters
...
- Fixed ETag issues on GRIB-data

* Fri Jan 24 2025 Mika Heiskanen <mika.heiskanen@fmi.fi> - 25.1.24-1.fmi
- Setting the number of timesteps to zero when using range requests
