...
#%if %{with observation}
#Requires: smartmet-engine-observation >= 25.5.22
#%endif
...
#TestRequires: smartmet-engine-grid-test >= 25.5.30
...
%if %{with observation}
#TestRequires: smartmet-engine-observation >= 25.5.22
%endif
#TestRequires: smartmet-engine-grid >= 25.5.30
