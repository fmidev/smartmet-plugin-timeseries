...
%endif
BuildRequires: smartmet-engine-querydata-devel >= 21.3.1
...
Requires: smartmet-engine-querydata >= 21.3.1
...
#TestRequires: smartmet-library-newbase-devel >= 21.3.1
...
#TestRequires: smartmet-engine-querydata-devel >= 21.3.1
%if %{with observation}
#TestRequires: smartmet-engine-observation-devel >= 21.2.25
%endif
