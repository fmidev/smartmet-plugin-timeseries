...
BuildRequires: smartmet-library-grid-files-devel >= 22.10.11
...
%if %{with observation}
BuildRequires: smartmet-engine-observation-devel >= 22.10.11
%endif
BuildRequires: smartmet-engine-querydata-devel >= 22.10.5
BuildRequires: smartmet-engine-gis-devel >= 22.10.5
BuildRequires: smartmet-engine-grid-devel >= 22.10.11
...
Requires: smartmet-engine-grid >= 22.10.11
...
#TestRequires: smartmet-engine-grid-test >= 22.10.11
...
%if %{with observation}
#TestRequires: smartmet-engine-observation >= 22.10.11
%endif
#TestRequires: smartmet-engine-grid >= 22.10.11
#TestRequires: gdal34
