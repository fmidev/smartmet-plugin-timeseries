...
private:
  ...
  TS::TimeSeriesGenerator::LocalTimeList generateQEngineQueryTimes(const Query& query, 
  ...
  Spine::LocationPtr resolveLocation(const Spine::TaggedLocation& tloc,
									 ...
									 NFmiSvgPath& svgPath,
									 bool& isWkt) const;
  TS::TimeSeriesGenerator::LocalTimeList generateTList(const Query& query,
  ...
  Spine::LocationList getLocationListForPath(const Query& theQuery,
											 ...
											 const State& theState,
											 bool isWkt) const;
  TS::TimeSeriesGroupPtr getQEngineValuesForArea(const Query& theQuery,
												 const std::string& theProducer,
												 const TS::ParameterAndFunctions& theParamFunc,
												 const Spine::TaggedLocation& theTLoc,
